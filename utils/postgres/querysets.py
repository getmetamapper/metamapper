...
from utils.postgres.sql import PostgresInsertQuery, PostgresQuery
...
class PostgresQuerySet(models.QuerySet):
    ...
    def on_conflict(self, fields, action=ConflictAction, index_predicate=None):
        ...
        Arguments:
            ...
            index_predicate:
                The index predicate to satisfy an arbiter partial index
                    (i.e. what partial index to use for checking conflicts)
        """
    ...
    def bulk_insert(self, rows, return_model=False, using=None, only_fields=None):
    ...
    def insert(self, using=None, only_fields=None, **fields):
        ...
        if self.conflict_target or self.conflict_action:
            compiler = self._build_insert_compiler([fields], using=using, only_fields=only_fields)
    ...
    def insert_and_get(self, using=None, only_fields=None, **fields):
    ...
    def upsert(self, conflict_target, fields, index_predicate=None, using=None):
    ...
    def upsert_and_get(self, conflict_target, fields, index_predicate, using=None):
    ...
    def bulk_upsert(self, conflict_target, rows, index_predicate=None, return_model=False, using=None):
    ...
    def _create_model_instance(self, field_values, using=None):
    ...
    def _build_insert_compiler(self, rows, using=None, only_fields=None):
        ...
        insert_fields, update_fields = self._get_upsert_fields(first_row, only_fields)
    ...
    def _is_magical_field(self, model_instance, field, is_insert):
        ...
        "Magical" means that a field modifies the field value during the pre_save.
    ...
    def _get_upsert_fields(self, kwargs, only_fields=None):
